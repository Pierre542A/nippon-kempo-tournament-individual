...
module.exports = async function (fastify) {
  ...
  fastify.get("/account", { preHandler: verifyAuth }, async (_req, reply) => { reply.header('Cache-Control', 'no-store'); return reply.type("text/html").sendFile("account.html"); });
  fastify.get("/edit", { preHandler: verifyAuth }, async (_req, reply) => { reply.header('Cache-Control', 'no-store'); return reply.type("text/html").sendFile("edit-account.html"); });
  fastify.get("/login", async (_req, reply) => reply.type("text/html").sendFile("login.html"));
  fastify.get("/register", async (_req, reply) => reply.type("text/html").sendFile("register.html"));
